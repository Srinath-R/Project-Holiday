      ...
      <div class="main-header" style="height: 150px;">
        <div class="main-header__intro-wrapper">
          <div class="main-header__welcome">
            <div class="main-header__welcome-title text-light">View Leave Requests</div>
          </div>
          ...
          <div id="table" class="table-editable">
            ...
            <table class="table table-bordered table-responsive-md table-striped text-center">
              ...
              <c:forEach var="leave" items="${listLeave}">
                <tr>
                  <td class="pt-3-half" contenteditable="true"><c:out value="${leave.id}" /></td>
                  <td class="pt-3-half" contenteditable="true"><c:out value="${leave.applied_from}" /></td>
                  <td class="pt-3-half" contenteditable="true"><c:out value="${leave.applied_till}" /></td>
                  <td class="pt-3-half" contenteditable="true"><c:out value="${leave.type}" /></td>
                  <td class="pt-3-half" contenteditable="true"><c:out value="${leave.purpose}" /></td>
                  ...
                  <td>
                  	<c:choose>
                  		<c:when test="${leave.status == 'Approved'}"><!-- href="delete?id=leave.id" -->                    
                   		<span class="table-remove"><a href="./viewLeave?type=delete&id=<c:out value='${leave.id}' />"
                        class="btn btn-danger btn-rounded btn-sm my-0" disabled>Cancel</a></span></c:when>
                        <c:otherwise>
                        <!-- href="delete?id=leave.id" -->                    
                   		<span class="table-remove"><a href="./viewLeave?type=delete&id=<c:out value='${leave.id}' />"
                        class="btn btn-danger btn-rounded btn-sm my-0">Cancel</a></span>
                        </c:otherwise>
					</c:choose>
                  </td>
                </tr>
